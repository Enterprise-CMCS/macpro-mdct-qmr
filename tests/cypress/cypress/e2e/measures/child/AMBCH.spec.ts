...
describe("Measure 20: AMB-CH", () => {
  ...
  it("Ensure that Total NDR set is auto calculated from the according age ranges - OMS", () => {
    ...
    // OMS validation
    cy.get(
      '[data-cy="OptionalMeasureStratification.selections.3dpUZu.selections.ll9YP8.rateData.rates.8KgPDM.Total.0.numerator"]'
    ).type("4");
    cy.get(
      '[data-cy="OptionalMeasureStratification.selections.3dpUZu.selections.ll9YP8.rateData.rates.8KgPDM.Total.0.denominator"]'
    ).type("5");
    ...
    cy.get(
      '[data-cy="OptionalMeasureStratification.selections.3dpUZu.selections.ll9YP8.rateData.rates.8KgPDM.Total.0.rate"]'
