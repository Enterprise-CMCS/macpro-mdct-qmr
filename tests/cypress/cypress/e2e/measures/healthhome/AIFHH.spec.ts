...
describe("Measure: AIF-HH", () => {
  ...
  it("calculates correct rate totals for both PM and OMS", () => {
    ...
    cy.get(
      '[data-cy="OptionalMeasureStratification.selections.Race.selections.AmericanIndianorAlaskaNative.rateData.aifhh-rate.rates.ZyxRR5.Total.0.value"]'
    )
      .first()
      .clear()
      .type("3");
    cy.get(
      '[data-cy="OptionalMeasureStratification.selections.Race.selections.AmericanIndianorAlaskaNative.rateData.aifhh-rate.rates.ZyxRR5.Total.1.value"]'
    )
      .first()
      .clear()
      .type("7");
    cy.get(
      '[data-cy="OptionalMeasureStratification.selections.Race.selections.AmericanIndianorAlaskaNative.rateData.aifhh-rate.rates.ZyxRR5.Total.3.value"]'
    )
      .first()
      .clear()
      .type("1");
    cy.get(
      '[data-cy="OptionalMeasureStratification.selections.Race.selections.AmericanIndianorAlaskaNative.rateData.aifhh-rate.rates.ZyxRR5.Total.5.value"]'
    )
      .first()
      .clear()
      .type("1");
    ...
    cy.get(
      '[data-cy="OptionalMeasureStratification.selections.Race.selections.AmericanIndianorAlaskaNative.rateData.aifhh-rate.rates.ZyxRR5.Total.2.value"]'
    )
      .first()
      .should("have.value", "2333.3");
    cy.get(
      '[data-cy="OptionalMeasureStratification.selections.Race.selections.AmericanIndianorAlaskaNative.rateData.aifhh-rate.rates.ZyxRR5.Total.4.value"]'
    )
      .first()
      .should("have.value", "333.3");
    cy.get(
      '[data-cy="OptionalMeasureStratification.selections.Race.selections.AmericanIndianorAlaskaNative.rateData.aifhh-rate.rates.ZyxRR5.Total.6.value"]'
    )
      .first()
      .should("have.value", "333.3");
