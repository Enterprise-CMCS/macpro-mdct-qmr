describe("Measure: CIS-CH", () => {
  ...
  it("fill out the CIS-CH form until PM section with NDR verification", () => {
    ...
    cy.get(
      '[data-cy="Denominators for all reported rates for this measure should be the same"]'
    ).should(
      "have.text",
  ...
  it("verify OMS section", () => {
    ...
    cy.get(
      '[data-cy="DataSourceSelections.HybridAdministrativeandMedicalRecordsData0.selected2"] > .chakra-checkbox__control'
    ).click();
    cy.get(
      "#DataSourceSelections\\.HybridAdministrativeandMedicalRecordsData0\\.selected2-checkbox"
    ).check();
    cy.get(
    ...
    cy.get(
      '[data-cy="Deviations.DTaP.RateDeviationsSelected0"] > .chakra-checkbox__control'
    ).click();
    cy.get("#Deviations\\.DTaP\\.RateDeviationsSelected0-checkbox").check();
    cy.get(
      '[data-cy="Deviations.DTaP.RateDeviationsSelected1"] > .chakra-checkbox__control'
    ).click();
    cy.get("#Deviations\\.DTaP\\.RateDeviationsSelected1-checkbox").check();
    cy.get(
      '[data-cy="Deviations.DTaP.RateDeviationsSelected2"] > .chakra-checkbox__control'
    ).click();
    ...
    cy.get(
      '[data-cy="OptionalMeasureStratification.selections.RaceNonHispanic.selections.White.ageRangeRates.rates.DTaP.0.0.numerator"]'
    ).clear();
    cy.get(
      '[data-cy="OptionalMeasureStratification.selections.RaceNonHispanic.selections.White.ageRangeRates.rates.DTaP.0.0.numerator"]'
    ).type("2");
    cy.get(
      '[data-cy="OptionalMeasureStratification.selections.RaceNonHispanic.selections.White.ageRangeRates.rates.DTaP.0.0.denominator"]'
    ).clear();
    cy.get(
      '[data-cy="OptionalMeasureStratification.selections.RaceNonHispanic.selections.White.ageRangeRates.rates.DTaP.0.0.denominator"]'
    ).type("20");
    ...
    cy.get(
      '[data-cy="OptionalMeasureStratification.selections.Language.options0"] > .chakra-checkbox__control'
    ).click();
    cy.get(
      "#OptionalMeasureStratification\\.selections\\.Language\\.options0-checkbox"
    ).check();
    cy.get(
      '[data-cy="OptionalMeasureStratification.selections.Language.options0"] > .chakra-checkbox__label > .chakra-text'
    ).should("have.text", "English");
    cy.get(
      '[data-cy="OptionalMeasureStratification.selections.Language.options1"] > .chakra-checkbox__control'
    ).click();
    cy.get(
      "#OptionalMeasureStratification\\.selections\\.Language\\.options1-checkbox"
    ).check();
    cy.get(
