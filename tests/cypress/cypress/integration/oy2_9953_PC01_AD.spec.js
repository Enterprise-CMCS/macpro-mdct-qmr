describe("Measure: PC01-AD", () => {
  ...
  it('Fill out the form PC01_AD', function() {
    ...
    cy.get('[data-cy="DataSourceSelections.HybridAdministrativeandMedicalRecordsData1.selected0"]').click();
    ...
    cy.get('[data-cy="PerformanceMeasure.rates.singleCategory.0.numerator"]').type('5');
    cy.get('[data-cy="PerformanceMeasure.rates.singleCategory.0.denominator"]').click();
    cy.get('[data-cy="PerformanceMeasure.rates.singleCategory.0.denominator"]').clear();
    cy.get('[data-cy="PerformanceMeasure.rates.singleCategory.0.denominator"]').type('50');
    ...
    cy.get('[data-cy="DeviationOptions0"] > .chakra-checkbox__label > .chakra-text').should('have.text', 'Women with elective deliveries or C-sections at  ≥ 37 and <39 weeks');
    cy.get('[data-cy="Deviations.WomenwithelectivedeliveriesorCsectionsat37and39weeks.RateDeviationsSelected0"] > .chakra-checkbox__control').click();
    cy.get('#Deviations\\.WomenwithelectivedeliveriesorCsectionsat37and39weeks\\.RateDeviationsSelected0-checkbox').check();
    cy.get('[data-cy="Deviations.WomenwithelectivedeliveriesorCsectionsat37and39weeks.RateDeviationsSelected1"] > .chakra-checkbox__control').click();
    cy.get('#Deviations\\.WomenwithelectivedeliveriesorCsectionsat37and39weeks\\.RateDeviationsSelected1-checkbox').check();
    cy.get('[data-cy="Deviations.WomenwithelectivedeliveriesorCsectionsat37and39weeks.RateDeviationsSelected2"] > .chakra-checkbox__control').click();
    cy.get('#Deviations\\.WomenwithelectivedeliveriesorCsectionsat37and39weeks\\.RateDeviationsSelected2-checkbox').check();
    ...
    cy.get('[data-cy="OptionalMeasureStratification.selections.RaceNonHispanic.selections.White.rateData.options0"] > .chakra-checkbox__label > .chakra-text').should('have.text', 'Women with elective deliveries or C-sections at  ≥ 37 and <39 weeks');
    cy.get('[data-cy="OptionalMeasureStratification.selections.RaceNonHispanic.selections.White.rateData.rates.WomenwithelectivedeliveriesorCsectionsat37and39weeks.singleCategory.0.numerator"]').clear();
    cy.get('[data-cy="OptionalMeasureStratification.selections.RaceNonHispanic.selections.White.rateData.rates.WomenwithelectivedeliveriesorCsectionsat37and39weeks.singleCategory.0.numerator"]').type('5');
    cy.get('[data-cy="OptionalMeasureStratification.selections.RaceNonHispanic.selections.White.rateData.rates.WomenwithelectivedeliveriesorCsectionsat37and39weeks.singleCategory.0.denominator"]').clear();
    cy.get('[data-cy="OptionalMeasureStratification.selections.RaceNonHispanic.selections.White.rateData.rates.WomenwithelectivedeliveriesorCsectionsat37and39weeks.singleCategory.0.denominator"]').type('50');
    cy.get('[data-cy="OptionalMeasureStratification.selections.RaceNonHispanic.selections.White.rateData.rates.WomenwithelectivedeliveriesorCsectionsat37and39weeks.singleCategory.0.rate"]').should('have.value', '10.0');
    cy.get('[data-cy="OptionalMeasureStratification.selections.RaceNonHispanic.selections.White.rateData.rates.WomenwithelectivedeliveriesorCsectionsat37and39weeks.singleCategory.0.numerator"]').clear();
    cy.get('[data-cy="OptionalMeasureStratification.selections.RaceNonHispanic.selections.White.rateData.rates.WomenwithelectivedeliveriesorCsectionsat37and39weeks.singleCategory.0.numerator"]').type('0');
    cy.get('[data-cy="OptionalMeasureStratification.selections.RaceNonHispanic.selections.White.rateData.rates.WomenwithelectivedeliveriesorCsectionsat37and39weeks.singleCategory.0.rate"]').should('have.value', '0.0');
    cy.get('[data-cy="OptionalMeasureStratification.selections.RaceNonHispanic.selections.White.rateData.rates.WomenwithelectivedeliveriesorCsectionsat37and39weeks.singleCategory.0.numerator"]').click();
    cy.get('[data-cy="OptionalMeasureStratification.selections.RaceNonHispanic.selections.White.rateData.rates.WomenwithelectivedeliveriesorCsectionsat37and39weeks.singleCategory.0.numerator"]').clear();
    cy.get('[data-cy="OptionalMeasureStratification.selections.RaceNonHispanic.selections.White.rateData.rates.WomenwithelectivedeliveriesorCsectionsat37and39weeks.singleCategory.0.numerator"]').type('5');
    cy.get(':nth-child(1) > :nth-child(1) > :nth-child(1) > :nth-child(2) > :nth-child(1) > :nth-child(1) > :nth-child(2) > .css-0').click();
    cy.get(':nth-child(1) > :nth-child(1) > :nth-child(1) > :nth-child(2) > :nth-child(1) > :nth-child(1) > :nth-child(2) > .css-0').click();
    cy.get(':nth-child(1) > :nth-child(1) > :nth-child(1) > :nth-child(2) > :nth-child(1) > :nth-child(1) > :nth-child(2) > .css-0').click();
    cy.get('[data-cy="OptionalMeasureStratification.selections.RaceNonHispanic.selections.White.rateData.rates.WomenwithelectivedeliveriesorCsectionsat37and39weeks.singleCategory.0.rate"]').clear();
    cy.get('[data-cy="OptionalMeasureStratification.selections.RaceNonHispanic.selections.White.rateData.rates.WomenwithelectivedeliveriesorCsectionsat37and39weeks.singleCategory.0.rate"]').type('12.3');
    ...
    cy.get('[data-cy="OptionalMeasureStratification.selections.RaceNonHispanic.selections.NativeHawaiianorOtherPacificIslander.aggregate1"]').click();
    ...
    cy.get('[data-cy="OptionalMeasureStratification.selections.Geography.selections.Urban.rateData.options0"] > .chakra-checkbox__label > .chakra-text').should('have.text', 'Women with elective deliveries or C-sections at  ≥ 37 and <39 weeks');
    ...
    cy.get('[data-cy="OptionalMeasureStratification.selections.AdultEligibilityGroupACAExpansionGroup.rateData.options0"] > .chakra-checkbox__label > .chakra-text').should('have.text', 'Women with elective deliveries or C-sections at  ≥ 37 and <39 weeks');
    cy.get('[data-cy="Validate Measure"]').click();
    ...
    cy.get('[data-cy="Performance Measure Error"]').should('have.text', 'Performance Measure Error');
    cy.get('[data-cy="The checkmark for (Denominator Includes Medicare and Medicaid Dually-Eligible population) is checked but you are missing performance measure data for Ages 65 to 85"] > .chakra-text').should('have.text', 'The checkmark for (Denominator Includes Medicare and Medicaid Dually-Eligible population) is checked but you are missing performance measure data for Ages 65 to 85');
    /* ==== End Cypress Studio ==== */
  });
});
