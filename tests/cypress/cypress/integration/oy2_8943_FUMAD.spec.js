...
describe("Measure: FUM-AD", () => {
  ...
  //   cy.get('[data-cy="PerformanceMeasure-AgeRates-30Days.0.numerator"]').type("0");
  //   cy.get('[data-cy="PerformanceMeasure-AgeRates-30Days.0.denominator"]').clear();
  //   cy.get('[data-cy="PerformanceMeasure-AgeRates-30Days.0.denominator"]').type("5");
  //   cy.get('[data-cy="PerformanceMeasure-AgeRates-30Days.0.rate"]').should(
  //     "have.value",
  //     "0.0"
  //   );
  ...
  //     force: true,
  //   });
  //   cy.get('[data-cy="PerformanceMeasure-AgeRates-30Days.0.numerator"]').type("5");
  //   cy.get('[data-cy="PerformanceMeasure-AgeRates-30Days.0.denominator"]').clear();
  //   cy.get('[data-cy="PerformanceMeasure-AgeRates-30Days.0.denominator"]').type("5");
  //   cy.get('[data-cy="PerformanceMeasure-AgeRates-30Days.0.rate"]').should(
  //     "have.value",
  ...
  it("Age ranges are represented in DMS and OMS", () => {
    ...
    cy.get(
      '[data-cy="NonHispanicRacialCategories1"] > .chakra-checkbox__label > .chakra-text'
    ).should("be.visible");
    cy.get(
      '[data-cy="PerformanceMeasure-AgeRates-30Days.1.denominator"]'
    ).clear();
