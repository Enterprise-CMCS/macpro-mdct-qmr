describe("Measure: IU-HH", () => {
  ...
  it("calculates correct rate totals for both PM and OMS", () => {
    ...
    cy.get(
      '[data-cy="OptionalMeasureStratification.selections.RaceNonHispanic.selections.White.rateData.iuhh-rate.options0"]'
    ).click();

    cy.get(
      '[data-cy="OptionalMeasureStratification.selections.RaceNonHispanic.selections.White.rateData.iuhh-rate.rates.Ages0to17.Inpatient.0.value"]'
    )
      .first()
      .clear()
      .type("3");
    cy.get(
      '[data-cy="OptionalMeasureStratification.selections.RaceNonHispanic.selections.White.rateData.iuhh-rate.rates.Ages0to17.Inpatient.1.value"]'
    )
      .first()
      .clear()
      .type("7");
    cy.get(
      '[data-cy="OptionalMeasureStratification.selections.RaceNonHispanic.selections.White.rateData.iuhh-rate.rates.Ages0to17.Inpatient.3.value"]'
    )
      .first()
      .clear()
      .type("1");
