describe("Measure: AIF-HH", () => {
  ...
  it("calculates correct rate totals for both PM and OMS", () => {
    ...
    cy.get(
      '[data-cy="OptionalMeasureStratification.selections.RaceNonHispanic.selections.White.rateData.aifhh-rate.rates.Ages0to17.Inpatient.0.value"]'
    )
      .first()
      .clear()
      .type("3");
    cy.get(
      '[data-cy="OptionalMeasureStratification.selections.RaceNonHispanic.selections.White.rateData.aifhh-rate.rates.Ages0to17.Inpatient.1.value"]'
    )
      .first()
      .clear()
      .type("7");
    cy.get(
      '[data-cy="OptionalMeasureStratification.selections.RaceNonHispanic.selections.White.rateData.aifhh-rate.rates.Ages0to17.Inpatient.3.value"]'
    )
      .first()
      .clear()
      .type("1");
    ...
    cy.get(
      '[data-cy="OptionalMeasureStratification.selections.RaceNonHispanic.selections.White.rateData.aifhh-rate.rates.Ages0to17.Inpatient.2.value"]'
    )
      .first()
      .should("have.value", "2333.3");
    cy.get(
      '[data-cy="OptionalMeasureStratification.selections.RaceNonHispanic.selections.White.rateData.aifhh-rate.rates.Ages0to17.Inpatient.4.value"]'
    )
      .first()
      .should("have.value", "333.3");
    cy.get(
      '[data-cy="OptionalMeasureStratification.selections.RaceNonHispanic.selections.White.rateData.aifhh-rate.rates.Ages0to17.Inpatient.5.value"]'
    )
      .first()
      .should("have.value", "0.1");
    ...
    cy.get(
      '[data-cy="OptionalMeasureStratification.selections.RaceNonHispanic.selections.White.rateData.aifhh-rate.rates.Total.Inpatient.0.value"]'
    ).should("have.value", "3");
    cy.get(
      '[data-cy="OptionalMeasureStratification.selections.RaceNonHispanic.selections.White.rateData.aifhh-rate.rates.Total.Inpatient.1.value"]'
    ).should("have.value", "7");
    cy.get(
      '[data-cy="OptionalMeasureStratification.selections.RaceNonHispanic.selections.White.rateData.aifhh-rate.rates.Total.Inpatient.2.value"]'
    ).should("have.value", "2333.3");
    cy.get(
      '[data-cy="OptionalMeasureStratification.selections.RaceNonHispanic.selections.White.rateData.aifhh-rate.rates.Total.Inpatient.3.value"]'
    ).should("have.value", "1");
    cy.get(
      '[data-cy="OptionalMeasureStratification.selections.RaceNonHispanic.selections.White.rateData.aifhh-rate.rates.Total.Inpatient.4.value"]'
    ).should("have.value", "333.3");
    cy.get(
      '[data-cy="OptionalMeasureStratification.selections.RaceNonHispanic.selections.White.rateData.aifhh-rate.rates.Total.Inpatient.5.value"]'
    ).should("have.value", "0.1");
