describe("Measure: AMR-CH", () => {
  ...
  it("automatically applies Total NDR set for OMS sections nested in checkbox", () => {
    ...
    cy.get(
      '[data-cy="OptionalMeasureStratification.selections.RaceNonHispanic.selections.BlackorAfricanAmerican.rateData.rates.Ages5to11.singleCategory.0.numerator"]'
    ).type("5");
    cy.get(
      '[data-cy="OptionalMeasureStratification.selections.RaceNonHispanic.selections.BlackorAfricanAmerican.rateData.rates.Ages5to11.singleCategory.0.denominator"]'
    ).type("6");
    cy.get(
      '[data-cy="OptionalMeasureStratification.selections.RaceNonHispanic.selections.BlackorAfricanAmerican.rateData.rates.Ages12to18.singleCategory.0.numerator"]'
    ).type("7");
    cy.get(
    ...
    cy.get(
      '[data-cy="OptionalMeasureStratification.selections.RaceNonHispanic.selections.BlackorAfricanAmerican.rateData.rates.TotalAges5to18.singleCategory.0.denominator"]'
    ).should("have.value", "14");
    cy.get(
      '[data-cy="OptionalMeasureStratification.selections.RaceNonHispanic.selections.BlackorAfricanAmerican.rateData.rates.TotalAges5to18.singleCategory.0.rate"]'
