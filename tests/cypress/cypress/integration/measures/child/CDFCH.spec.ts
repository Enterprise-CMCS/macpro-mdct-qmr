...
describe("Measure: oy2-8979 CDF-CH", () => {
  ...
  it("Fill out the CDF-CH form and verify NDR section in PM OMS", function () {
    ...
    cy.get(
      '[data-cy="OptionalMeasureStratification.selections.3dpUZu.selections.ll9YP8.rateData.options0"] > .chakra-checkbox__control > div'
    ).click();
    cy.get(
      '[data-cy="OptionalMeasureStratification.selections.3dpUZu.selections.ll9YP8.rateData.options0"] > .chakra-checkbox__control'
    ).click();
    ...
    cy.get(
      '[data-cy="OptionalMeasureStratification.selections.3dpUZu.selections.ll9YP8.rateData.rates.hsjQhs.HgCHDt.0.numerator"]'
    ).click();
    cy.get(
      '[data-cy="OptionalMeasureStratification.selections.3dpUZu.selections.ll9YP8.rateData.rates.hsjQhs.HgCHDt.0.numerator"]'
    ).click();
    ...
    cy.get(
      '[data-cy="OptionalMeasureStratification.selections.3dpUZu.selections.ll9YP8.rateData.rates.hsjQhs.HgCHDt.0.denominator"]'
    ).click();
    cy.get(
      '[data-cy="OptionalMeasureStratification.selections.3dpUZu.selections.ll9YP8.rateData.rates.hsjQhs.HgCHDt.0.denominator"]'
    ).clear();
    ...
    cy.get(
      '[data-cy="OptionalMeasureStratification.selections.3dpUZu.selections.ll9YP8.rateData.rates.hsjQhs.HgCHDt.0.rate"]'
