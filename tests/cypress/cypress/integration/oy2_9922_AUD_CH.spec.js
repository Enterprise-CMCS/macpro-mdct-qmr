describe("Measure: oy2_9922 AUD-CH", () => {
  ...
  it("should show correct data source options", () => {
    cy.get('[data-cy="DataSource0"] > .chakra-checkbox__label > .chakra-text').should('have.text', 'Electronic Health Records');
    cy.get('[data-cy="DataSource1"] > .chakra-checkbox__label > .chakra-text').should('have.text', 'Other');
  ...
  it('Fill out the measurement AUD_CH', function() {
    ...
    cy.get('.css-n21gh5 > .chakra-text').should('have.text', 'Percentage of newborns who did not pass hearing screening and have an audiological diagnosis no later than 3 months of age (90 days).');
    ...
    cy.get('[data-cy="Deviations.Percentageofnewbornswhodidnotpasshearingscreeningandhaveanaudiologicaldiagnosisnolaterthan3monthsofage.RateDeviationsSelected0"] > .chakra-checkbox__control').click();
    cy.get('#Deviations\\.Percentageofnewbornswhodidnotpasshearingscreeningandhaveanaudiologicaldiagnosisnolaterthan3monthsofage\\.RateDeviationsSelected0-checkbox').check();
    cy.get('[data-cy="Deviations.Percentageofnewbornswhodidnotpasshearingscreeningandhaveanaudiologicaldiagnosisnolaterthan3monthsofage.RateDeviationsSelected1"] > .chakra-checkbox__control').click();
    cy.get('#Deviations\\.Percentageofnewbornswhodidnotpasshearingscreeningandhaveanaudiologicaldiagnosisnolaterthan3monthsofage\\.RateDeviationsSelected1-checkbox').check();
    cy.get('[data-cy="Deviations.Percentageofnewbornswhodidnotpasshearingscreeningandhaveanaudiologicaldiagnosisnolaterthan3monthsofage.RateDeviationsSelected2"] > .chakra-checkbox__control').click();
    cy.get('#Deviations\\.Percentageofnewbornswhodidnotpasshearingscreeningandhaveanaudiologicaldiagnosisnolaterthan3monthsofage\\.RateDeviationsSelected2-checkbox').check();
    ...
    cy.get('[data-cy="OptionalMeasureStratification.selections.RaceNonHispanic.selections.White.rateData.options0"] > .chakra-checkbox__label > .chakra-text').should('have.text', 'Percentage of newborns who did not pass hearing screening and have an audiological diagnosis no later than 3 months of age');
    ...
    cy.get('[data-cy="OptionalMeasureStratification.selections.RaceNonHispanic.selections.White.rateData.rates.Percentageofnewbornswhodidnotpasshearingscreeningandhaveanaudiologicaldiagnosisnolaterthan3monthsofage.singleCategory.0.numerator"]').clear();
    cy.get('[data-cy="OptionalMeasureStratification.selections.RaceNonHispanic.selections.White.rateData.rates.Percentageofnewbornswhodidnotpasshearingscreeningandhaveanaudiologicaldiagnosisnolaterthan3monthsofage.singleCategory.0.numerator"]').type('2');
    cy.get('[data-cy="OptionalMeasureStratification.selections.RaceNonHispanic.selections.White.rateData.rates.Percentageofnewbornswhodidnotpasshearingscreeningandhaveanaudiologicaldiagnosisnolaterthan3monthsofage.singleCategory.0.denominator"]').clear();
    cy.get('[data-cy="OptionalMeasureStratification.selections.RaceNonHispanic.selections.White.rateData.rates.Percentageofnewbornswhodidnotpasshearingscreeningandhaveanaudiologicaldiagnosisnolaterthan3monthsofage.singleCategory.0.denominator"]').type('20');
    cy.get('[data-cy="OptionalMeasureStratification.selections.RaceNonHispanic.selections.White.rateData.rates.Percentageofnewbornswhodidnotpasshearingscreeningandhaveanaudiologicaldiagnosisnolaterthan3monthsofage.singleCategory.0.rate"]').should('have.value', '10.0');
    cy.get('[data-cy="OptionalMeasureStratification.selections.RaceNonHispanic.selections.White.rateData.rates.Percentageofnewbornswhodidnotpasshearingscreeningandhaveanaudiologicaldiagnosisnolaterthan3monthsofage.singleCategory.0.numerator"]').clear();
    cy.get('[data-cy="OptionalMeasureStratification.selections.RaceNonHispanic.selections.White.rateData.rates.Percentageofnewbornswhodidnotpasshearingscreeningandhaveanaudiologicaldiagnosisnolaterthan3monthsofage.singleCategory.0.numerator"]').type('0');
    cy.get('[data-cy="OptionalMeasureStratification.selections.RaceNonHispanic.selections.White.rateData.rates.Percentageofnewbornswhodidnotpasshearingscreeningandhaveanaudiologicaldiagnosisnolaterthan3monthsofage.singleCategory.0.rate"]').should('have.value', '0.0');
    cy.get('[data-cy="OptionalMeasureStratification.selections.RaceNonHispanic.selections.White.rateData.rates.Percentageofnewbornswhodidnotpasshearingscreeningandhaveanaudiologicaldiagnosisnolaterthan3monthsofage.singleCategory.0.rate"]').click();
    cy.get('[data-cy="OptionalMeasureStratification.selections.RaceNonHispanic.selections.White.rateData.rates.Percentageofnewbornswhodidnotpasshearingscreeningandhaveanaudiologicaldiagnosisnolaterthan3monthsofage.singleCategory.0.rate"]').clear();
    cy.get('[data-cy="OptionalMeasureStratification.selections.RaceNonHispanic.selections.White.rateData.rates.Percentageofnewbornswhodidnotpasshearingscreeningandhaveanaudiologicaldiagnosisnolaterthan3monthsofage.singleCategory.0.rate"]').type('12.3');
    ...
    cy.get(':nth-child(3) > div.css-0 > [data-cy="Manually entered rate should be 0 if numerator is 0"] > .chakra-text').should('have.text', 'Manually entered rate should be 0 if numerator is 0');
    cy.get('[data-cy="Performance Measure/Other Performance Measure Error"]').should('have.text', 'Performance Measure/Other Performance Measure Error');
    cy.get(':nth-child(4) > div.css-0 > [data-cy="Manually entered rate should be 0 if numerator is 0"] > .chakra-text').should('have.text', 'Manually entered rate should be 0 if numerator is 0');
    /* ==== End Cypress Studio ==== */
  });
});
