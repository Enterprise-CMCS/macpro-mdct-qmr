Feature: Verify and fill out MSC-AD measurement

      Scenario: User logins to QMR and verifies fill out the MSC-AD measurement page for No option
    ...
    Scenario: User logins to QMR and verifies fill out the MSC-AD measurement page for Yes option
            Given user visits QMR home page
            When  login as state user two
            And   user click on link Adult Core Set Measures
            And   user click on link MSC-AD
