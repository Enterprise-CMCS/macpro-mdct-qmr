Feature: Verify and fill out CCP-AD measurement

      Scenario: User logins to QMR and verifies fill out the CCP-AD measurement page for No option
    ...
    Scenario: User logins to QMR and verifies fill out the CCP-AD measurement page for Yes option
            Given user visits QMR home page
            When  login as state user two
            And   user click on link Adult Core Set Measures
            And   user click on link CCP-AD
