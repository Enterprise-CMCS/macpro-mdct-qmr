...
describe("OY2-16228 Date Range Adjustment for Start/End date", () => {
  ...
  it("Not allow same date", function () {
    ...
    cy.get(
      ".chakra-toast > .chakra-toast__inner > #\\31  > .css-njbp03 > .chakra-alert__desc"
    ).should("be.visible");
    cy.get(
  ...
  it("Not allow start date late than end date", function () {
    ...
    cy.get(
      '#popover-header-185 > .chakra-stack > [aria-label="Previous Year"] > svg'
    ).click();
    cy.get('#popover-body-185 > .css-1isix7b > [aria-label="January"]').click();
    ...
    cy.get(
      '#popover-header-189 > .chakra-stack > [aria-label="Previous Year"] > svg'
    ).click();
    cy.get(
      '#popover-header-189 > .chakra-stack > [aria-label="Previous Year"] > svg'
    ).click();
    ...
    cy.get(
      '#popover-header-189 > .chakra-stack > [aria-label="Next Year"]'
    ).click();
    cy.get(
      '#popover-header-189 > .chakra-stack > [aria-label="Previous Year"] > svg'
    ).click();
  ...
  it("Not allow only enter start date not end date and click on validate measure", function () {
    ...
    cy.get('#popover-body-185 > .css-1isix7b > [aria-label="January"]').click();
    cy.get('[data-cy="Validate Measure"]').click();
    cy.get('[data-cy="Date Range must have a End Date"]').should(
      "have.text",
      "Date Range must have a End Date"
    );
    /* ==== End Cypress Studio ==== */
  });
});
