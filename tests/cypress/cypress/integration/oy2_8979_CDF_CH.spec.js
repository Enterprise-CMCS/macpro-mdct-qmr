...
describe("Measure: oy2-8979 CDF-CH", () => {
  ...
  it("Fill out the CDF-CH form and verify NDR section in PM OMS", function () {
    ...
    cy.get('[data-cy="DataSource1"] > .chakra-checkbox__label > .chakra-text').should('have.text', 'Electronic Health Records');
    cy.get('[data-cy="DataSource2"] > .chakra-checkbox__label > .chakra-text').should('have.text', 'Other Data Source');
    ...
    cy.get('[data-cy="PerformanceMeasure.rates.singleCategory.0.numerator"]').type('12');
    cy.get('[data-cy="PerformanceMeasure.rates.singleCategory.0.denominator"]').clear();
    cy.get('[data-cy="PerformanceMeasure.rates.singleCategory.0.denominator"]').type('22');
    cy.get('[data-cy="PerformanceMeasure.rates.singleCategory.0.rate"]').should('have.value', '54.5');
    cy.get('[data-cy="PerformanceMeasure.rates.singleCategory.0.numerator"]').clear();
    ...
    cy.get('[data-cy="OptionalMeasureStratification.selections.RaceNonHispanic.selections.White.rateData.options0"] > .chakra-checkbox__control > div').click();
    cy.get('#OptionalMeasureStratification\\.selections\\.RaceNonHispanic\\.selections\\.White\\.rateData\\.options0-checkbox').uncheck();
    cy.get('[data-cy="OptionalMeasureStratification.selections.RaceNonHispanic.selections.White.rateData.options0"] > .chakra-checkbox__control').click();
    cy.get('#OptionalMeasureStratification\\.selections\\.RaceNonHispanic\\.selections\\.White\\.rateData\\.options0-checkbox').check();
    cy.get('[data-cy="OptionalMeasureStratification.selections.RaceNonHispanic.selections.White.rateData.options0"] > .chakra-checkbox__control > div').click();
    cy.get('#OptionalMeasureStratification\\.selections\\.RaceNonHispanic\\.selections\\.White\\.rateData\\.options0-checkbox').uncheck();
    cy.get('[data-cy="OptionalMeasureStratification.selections.RaceNonHispanic.selections.White.rateData.options0"] > .chakra-checkbox__control').click();
    cy.get('#OptionalMeasureStratification\\.selections\\.RaceNonHispanic\\.selections\\.White\\.rateData\\.options0-checkbox').check();
    cy.get('[data-cy="OptionalMeasureStratification.selections.RaceNonHispanic.selections.White.rateData.rates.Ages12to17.singleCategory.0.numerator"]').click();
    cy.get('[data-cy="OptionalMeasureStratification.selections.RaceNonHispanic.selections.White.rateData.rates.Ages12to17.singleCategory.0.numerator"]').click();
    ...
    cy.get('[data-cy="OptionalMeasureStratification.selections.RaceNonHispanic.selections.White.rateData.rates.Ages12to17.singleCategory.0.numerator"]').type('2');
    ...
    cy.get('[data-cy="OptionalMeasureStratification.selections.RaceNonHispanic.selections.White.rateData.rates.Ages12to17.singleCategory.0.rate"]').should('have.value', '10.0');
    cy.get('[data-cy="OptionalMeasureStratification.selections.RaceNonHispanic.selections.White.rateData.rates.Ages12to17.singleCategory.0.numerator"]').clear();
    cy.get('[data-cy="OptionalMeasureStratification.selections.RaceNonHispanic.selections.White.rateData.rates.Ages12to17.singleCategory.0.numerator"]').type('0');
    cy.get('[data-cy="OptionalMeasureStratification.selections.RaceNonHispanic.selections.White.rateData.rates.Ages12to17.singleCategory.0.rate"]').should('have.value', '0.0');
    cy.get(':nth-child(12) > :nth-child(3)').click();
    cy.get('[data-cy="OptionalMeasureStratification.selections.RaceNonHispanic.selections.White.rateData.rates.Ages12to17.singleCategory.0.rate"]').click();
    cy.get('[data-cy="OptionalMeasureStratification.selections.RaceNonHispanic.selections.White.rateData.rates.Ages12to17.singleCategory.0.rate"]').clear();
    cy.get('[data-cy="OptionalMeasureStratification.selections.RaceNonHispanic.selections.White.rateData.rates.Ages12to17.singleCategory.0.rate"]').type('12.3');
    cy.get('[data-cy="OptionalMeasureStratification.selections.RaceNonHispanic.selections.White.rateData.rates.Ages12to17.singleCategory.0.rate"]').should('have.value', '12.3');
    cy.get(':nth-child(12) > :nth-child(3)').click();
