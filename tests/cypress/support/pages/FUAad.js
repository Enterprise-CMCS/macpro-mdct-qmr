...
const serviceNotCovered =
  "(//span[@class='chakra-checkbox__control css-1oi6yiz'])[1]";
const populationNotCovered =
  "(//span[@class='chakra-checkbox__control css-1oi6yiz'])[2]";
//====Radio options when click on Population not covered=====//
const entirePopulationNotCover =
  "(//span[@class='chakra-radio__control css-gzpnyx'])[3]";
const partialPopulationNotCover =
  "(//span[@class='chakra-radio__control css-gzpnyx'])[4]";
const explainPartialNotCover = "//textarea[@id='field-247']";
const dataNotAvailable =
  "(//span[@class='chakra-checkbox__control css-1oi6yiz'])[3]";
//====Checkbox when click on Data not available====//
const budgetConstrains =
  "(//span[@class='chakra-checkbox__control css-1oi6yiz'])[4]";
const staffConstraints =
  "(//span[@class='chakra-checkbox__control css-1oi6yiz'])[5]";
const dataInconsistencies =
  "(//span[@class='chakra-checkbox__control css-1oi6yiz'])[6]";
const explainDataInconsistency = "//textarea[@id='field-249']";
const dataSourceNotEasy =
  "(//span[@class='chakra-checkbox__control css-1oi6yiz'])[7]";
const requiresMedicalRecordReview =
  "(//span[@class='chakra-checkbox__control css-1oi6yiz'])[8]";
const requiresDataLinkage =
  "(//span[@class='chakra-checkbox__control css-1oi6yiz'])[9]";
const otherDataSource =
  "(//span[@class='chakra-checkbox__control css-1oi6yiz'])[10]";
const explainOtherDataSource = "//textarea[@id='field-254']";
const informationNotCollected =
  "(//span[@class='chakra-checkbox__control css-1oi6yiz'])[8]";
const otherNotAvailable =
  "(//span[@class='chakra-checkbox__control css-1oi6yiz'])[9]";

const limitationPandemic =
  "(//span[@class='chakra-checkbox__control css-1oi6yiz'])[4]";
const smallSample =
  "(//span[@class='chakra-checkbox__control css-1oi6yiz'])[5]";
const otherOption =
