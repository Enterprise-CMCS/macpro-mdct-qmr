  ...
  DefinitionsOfPopulation: {
    ...
    coreSetSpecificOptions: {
      ACSM: {
        ...
        helpText:
          "Please select all populations that are included in the denominator. For example, if your data include Medicaid (Title XIX) beneficiaries, Medicaid-Expansion CHIP (Title XXI) beneficiaries, and individuals dually eligible for Medicare and Medicaid, select:",
      },
      CCSM: {
        options: [
          {
        ...
        helpText:
          "Please select all populations that are included in the denominator. For example, if your data include both Medicaid (Title XIX) and Medicaid-Expansion CHIP (Title XXI) beneficiaries, select both:",
      },
      ACSC: {
        options: [
          {
