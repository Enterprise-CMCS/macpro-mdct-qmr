...
export const commonQuestionsLabel = {
  ...
  MeasureStratification: {
    ...
    instructions: [
      [
        "Enter data below to stratify this measure by race, ethnicity, sex, and/or geography. Beginning with 2025 Core Sets reporting, states are required to report stratified data for a specific subset of Child, Adult, and Health Home Core Set measures. More information on stratification reporting requirements, including the list of measures and rates subject to mandatory stratification for 2026 Core Set reporting, is included in the ",
        { link: "strat-ta-resource" },
        ".",
      ],
      [
        "For 2026 Core Sets reporting, states have the option to stratify race and ethnicity data using either (1) the ",
        { link: "1997-omb-for-2026" },
        ", as specified in the ",
        { link: "hss-standard" },
        ", or (2) the ",
        { link: "2024-omb" },
