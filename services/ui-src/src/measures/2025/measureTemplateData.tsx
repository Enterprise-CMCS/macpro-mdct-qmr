...
import { data as EDVAD_Data } from "./EDVAD/data";
import { validationFunctions as EDVAD_Validations } from "./EDVAD/validation";
...
import { validationFunctions as OEVPAD_Validations } from "./OEVPAD/validation";

import { data as OEVPCH_Data } from "./OEVPCH/data";
import { validationFunctions as OEVPCH_Validations } from "./OEVPCH/validation";
...
export const measureTemplateData: { [measure: string]: any } = {
  ...
  "EDV-AD": { data: EDVAD_Data, validationFunctions: EDVAD_Validations },
  ...
  "OEVP-AD": { data: OEVPAD_Data, validationFunctions: OEVPAD_Validations },
  "OEVP-CH": { data: OEVPCH_Data, validationFunctions: OEVPCH_Validations },
