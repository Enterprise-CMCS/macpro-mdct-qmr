...
export const NCIDDSAD = ({ name, year }: Props) => {
  return (
    <QMR.AutocompletedMeasureTemplate
      ...
      performanceMeasureText="The National Core Indicators® - Intellectual and Development Disabilities (NCI-DD®) provide information on
        ...
        developmental disabilities (I/DD) and their families. NCI-DD includes
        ...
        from the NCI-DD in-person survey will be reported."
