...
// These validations are for Single Array performance measure arrays

export const atLeastOneRateCompleteSingleArray = (
...
export const validateNumeratorsLessThanDenominatorsSingleArray = (
  performanceMeasureArray: any,
  OPM: any
) => {
  let error = false;
...
export const validateEqualDenominatorsSingleArray = (
  performanceMeasureArray: any
) => {
  let error;
  let errorArray: any[] = [];
...
// It must be zero if the numerator is zero or
// It Must be greater than zero if the Num and Denom are greater than zero
export const validateNoNonZeroNumOrDenomSingleArray = (
  performanceMeasureArray: any,
  OPM: any
) => {
  let nonZeroRateError = false;
