...
import { data as HPCAD_Data } from "./HPCAD/data";
...
import { data as PCRAD_Data } from "./PCRAD/data";
...
import { data as PCRHH_Data } from "./PCRHH/data";
...
export const measureTemplateData: { [measure: string]: any } = {
  ...
  "HPC-AD": { data: HPCAD_Data, validationFunctions: HPCAD_Validations },
  ...
  "PC01-AD": { data: PC01AD_Data, validationFunctions: PC01AD_Validations },
