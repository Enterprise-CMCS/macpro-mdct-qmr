...
export const data: DataDrivenTypes.PerformanceMeasure = {
  ...
  questionSubtext: [
    ...
    "PhasePercentage of children ages 6 to 12 with an ambulatory prescription dispensed for ADHD medication who remained on the medication for at least 210 days and who, in addition to the visit in the Initiation Phase, had at least two follow-up visits with a practitioner within 270 days (9 months) after the Initiation Phase ended.",
  ],
  categories,
  qualifiers,
};
