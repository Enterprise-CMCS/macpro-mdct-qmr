  ...
  return (
    <QMR.CoreQuestionWrapper label="Definition of Population Included in the Measure">
      ...
      <CUI.Stack mt="5">
        ...
        <CUI.Text>
          Select all delivery systems that apply in your state. You must select
          at least one delivery system.
        </CUI.Text>
        <CUI.Text>
          For each selected delivery system, enter the percentage and number of
          enrollees covered by that delivery system that are included in the
          data reported for this measure. For example, if the measure-eligible
          population represents all managed care enrollees, enter 100 percent
          for MCO, and the number covered.
        </CUI.Text>
        <QMR.Checkbox
          formLabelProps={{ fontWeight: "400" }}
          ...
          options={[
                  ...
                  options={[
                    ...
                    },
                    {
                      ...
                      children: [
                        ...
                        />,
                        <CUI.Box py="5" key="AdditionalPCCMText"></CUI.Box>,
                        <QMR.NumberInput
                      ...
                      },
                      {
                        ...
                        children: [
                          ...
                          <CUI.Text my="5" key="AdditionalMCOExcludedText">
                            {" "}
                            {
                              "What number of your measure-eligible Managed Care Organization/Pre-paid Inpatient Health Plan (MCO/PIHP) plans are"
                            }
                            <CUI.Text as="i" fontWeight="600">
                              {" excluded "}
                            </CUI.Text>
            ...
            },
            {
              ...
              children: [
                ...
                <CUI.Box py="5" key="AdditionalOtherText"></CUI.Box>,
