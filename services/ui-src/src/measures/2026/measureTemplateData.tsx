...
export const measureTemplateData: { [measure: string]: any } = {
  ...
  "EDV-AD": { data: EDVAD_Data, validationFunctions: validationFunctions },
  ...
  "GSD-AD": { data: GSDAD_Data, validationFunctions: validationFunctions },
  ...
  "PRS-AD": { data: PRSAD_Data, validationFunctions: validationFunctions },
  "PRS-CH": { data: PRSCH_Data, validationFunctions: validationFunctions },
