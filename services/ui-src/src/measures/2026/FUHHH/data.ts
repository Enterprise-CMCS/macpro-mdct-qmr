...
export const data: MeasureTemplateData = {
  ...
  performanceMeasure: {
    questionText: [
      "Percentage of discharges for enrollees age 6 and older who were hospitalized for a principal diagnosis of mental illness, or any diagnosis of intentional self-harm, and had a mental health follow-up service. Two rates are reported:",
    ],
    questionListItems: [
