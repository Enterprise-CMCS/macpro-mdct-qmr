...
export const data: MeasureTemplateData = {
  ...
  performanceMeasure: {
    questionText: [
      "Percentage of discharges for beneficiaries ages 6 to 17 who were hospitalized for principal diagnosis of mental illness, or any diagnosis of intentional self-harm, and had a follow-up service. Two rates are reported:",
    ],
    questionListItems: [
