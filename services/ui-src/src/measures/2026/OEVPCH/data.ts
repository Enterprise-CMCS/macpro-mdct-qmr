...
export const data: MeasureTemplateData = {
  ...
  performanceMeasure: {
    questionText: [
      "Percentage of enrolled persons ages 15 through 20 with live-birth deliveries in the measurement year who received a comprehensive or periodic oral evaluation during pregnancy. ",
    ],
    categories,
    qualifiers,
  },
