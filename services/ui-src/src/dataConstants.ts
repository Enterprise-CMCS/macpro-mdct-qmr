export const ADDITIONAL_CATS = "additionalCategories";
...
export const COMBINED_RATES_COMBINED_RATES = "CombinedRates-CombinedRates";
export const COMBINED_WEIGHTED_RATES = "Combined Weighted Rates";
...
export const DATA_SOURCE_SELECTIONS = "DataSourceSelections";
...
export const DELIVERY_SYS_FFS_NO_POP =
  "DeliverySys-FeeForService-No-Population";
export const DELIVERY_SYS_ICM = "DeliverySys-IntegratedCareModel";
export const DELIVERY_SYS_ICM_NO_PERCENT =
  "DeliverySys-IntegratedCareModel-No-Percent";
export const DELIVERY_SYS_ICM_NO_POP =
  "DeliverySys-IntegratedCareModel-No-Population";
export const DELIVERY_SYS_MCO_PIHP = "DeliverySys-MCO_PIHP";
export const DELIVERY_SYS_MCO_PIHP_NO_EXCL = "DeliverySys-MCO_PIHP-No-Excluded";
...
export const DELIVERY_SYS_PCCM_NO_POP =
  "DeliverySys-PrimaryCareManagement-No-Population";
export const DELIVERY_SYS_REPRESENTATION_DENOMINATOR =
  "DeliverySysRepresentationDenominator";
export const DENOMINATOR = "denominator";
export const DENOMINATOR_DEFINE_TOTAL_TECH_SPEC =
...
export const DENOMINATOR_DEFINE_HEALTH_HOME =
  "DenominatorDefineHealthHome";
...
export const MEASUREMENT_SPEC_OMS_DESCRIPTION =
