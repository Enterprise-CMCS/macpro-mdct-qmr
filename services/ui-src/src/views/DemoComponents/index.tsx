      ...
      <CUI.Container mb="6">
        <form>
          <CUI.Stack spacing="4">
            ...
            <CUI.Divider />
            <CUI.Heading id="text-area" size="sm" as="h3">
              Text Area
            </CUI.Heading>
            <Inputs.TextArea
            ...
            />
            <CUI.Divider />
            <CUI.Heading id="radio-button" size="sm" as="h3">
              Radio Button
            </CUI.Heading>
            <Inputs.RadioButton
              label="hello world"
            ...
            />
            <CUI.Divider />
            <CUI.Heading id="text-input" size="sm" as="h3">
              Text Input
            </CUI.Heading>
            <Inputs.TextInput
            ...
            />
            <CUI.Divider />
            <CUI.Heading id="select-input" size="sm" as="h3">
              Select Input
            </CUI.Heading>
            <Inputs.Select
            ...
            />
            <CUI.Divider />
            <CUI.Heading id="number-input-with-mask" size="sm" as="h3">
