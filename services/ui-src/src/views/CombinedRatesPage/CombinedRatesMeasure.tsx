    ...
    <>
      ...
      >
        ...
        <CUI.Text mt="4">
          ...
          combined Medicaid and CHIP rate based on these data, which is
          displayed in the “Combined Rate” column below. Please note, the
          combined Medicaid and CHIP rates will change if states update the
          individual Medicaid or Separate CHIP reports.
        </CUI.Text>
        <CUI.Text mt="4">
          This page is not editable. If your state would like to make edits to
          the data reported in the individual Medicaid or Separate CHIP reports,
          ...
          combined rates page to view the updated combined Medicaid and CHIP
          rate.{" "}
        </CUI.Text>
        <CUI.Text mt="4">
        ...
        <LoadingWrapper isLoaded={!queryResult.isLoading}>
          <DataSourceInformationBanner payload={combinedRateData} year={year} />
          {combinedRateData && (
            <>
              <CombinedRateNDR
