...
export const CoreSet = () => {
  ...
  const coreSetInstructions: { [key: string]: string } = {
    ...
    CC: "<p>For 2025 Core Sets reporting, states are required to report all of the measures on the Child Core Set (denoted as “Mandatory” in the measure list below). New measures are denoted as “Provisional” in the measure list below and are available for voluntary reporting in 2025.</p> <p>States with Title XXI-funded Medicaid expansion CHIP are expected to report data for this population in the Medicaid report (along with the Title XIX-funded Medicaid population).</p><p>More information on mandatory reporting requirements is included in the <a href='https://www.medicaid.gov/federal-policy-guidance/downloads/sho24001.pdf' target='_blank'>2025 Updates to the Child and Adult Core Health Care Quality Measurement Sets and Mandatory Reporting Guidance State Health Official Letter</a>.</p><p>For 2025 Core Sets reporting, states are expected to report stratified data for the following measures in the Child Medicaid report: FUH-CH, OEV-CH, PPC2-CH, W30-CH, and WCV-CH.</p>",
