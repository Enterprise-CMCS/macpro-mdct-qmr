...
export const CoreSet = () => {
  ...
  const coreSetInstructions: { [key: string]: { [key: string]: string } } = {
    ...
    "2026": {
      ...
      CCSC: "For 2026 Core Sets reporting, states are required to report the measures on the Child Core Set denoted as “Mandatory” in the measure list below. All other measures are available for voluntary reporting in 2026. More information on which measures are mandatory for 2026 is included in the 2026 Child Core Set Measure List. <p>&nbsp;</p> More information on mandatory reporting requirements is included in the <a href='https://www.medicaid.gov/federal-policy-guidance/downloads/sho24007.pdf' target='_blank'>2026 Updates to the Child and Adult Core Health Care Quality Measurement Sets and Mandatory Reporting Guidance State Health Official Letter</a>. <p>&nbsp;</p> For 2026 Core Sets reporting, states are expected to report stratified data for the following measures in the Child Separate CHIP report: AAB-CH, ADD-CH, AMR-CH, FUA-CH, FUH-CH, LSC-CH, OEV-CH, PPC2-CH, W30-CH, and WCV-CH. For 2026 reporting, states may choose to report stratified data for WCC-CH instead of AMR-CH because AMR-CH is being retired in 2027.",
