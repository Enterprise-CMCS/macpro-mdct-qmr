...
export const AddHHCoreSet = () => {
  ...
  return (
    <>
      <title>{`Add Health Home Core Set - ${year} QMR`}</title>
      <QMR.StateLayout
        breadcrumbItems={[
          {
            path: `/${state}/${year}`,
                  ...
                  <CUI.OrderedList spacing="10">
                    ...
                    <CUI.ListItem>
                      <CUI.Box>
                        ...
                        <CUI.Text pt={1}>
                          Remember to complete all Health Home Core Set
                          Questions and Health Home Core Set Measures to submit
                          for CMS review.
                        </CUI.Text>
