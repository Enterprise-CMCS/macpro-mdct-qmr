...
s3_dynamo_snapshot_bucket_region=`sh ../output.sh ../uploads Region $stage`
s3_dynamo_snapshot_bucket_name=`sh ../output.sh ../uploads DynamoSnapshotBucketName $stage`
...
export S3_DYNAMO_SNAPSHOT_BUCKET_REGION=$s3_dynamo_snapshot_bucket_region
export S3_DYNAMO_SNAPSHOT_BUCKET_NAME=$s3_dynamo_snapshot_bucket_name
